...
python tools/detection/misc/initialize_bbox_head.py --src1 work_dirs/meta-rcnn_sardet100k_split1_2xb4_BT/latest.pth --method random_init --save-dir work_dirs/meta-rcnn_sardet100k_split1_2xb4_BT/ --sardet100k
