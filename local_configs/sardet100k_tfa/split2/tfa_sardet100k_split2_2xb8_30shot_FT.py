...
lr_config = dict(warmup_iters=100, gamma=0.3, step=[7000])
...
work_dir = 'work_dirs/tfa/sardet100k/split2/2xb8_30shot_FT/'
# resume_from = \
#     'work_dirs/tfa/sardet100k/split2/2xb4_30shot_FT/iter_12000.pth'
