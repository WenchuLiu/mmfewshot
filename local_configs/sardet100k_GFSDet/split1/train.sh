#!/bin/bash
# sardet100k_GFSDet split1 training script
...
do
    CONFIG="local_configs/sardet100k_GFSDet/split1/GFSDet_sardet100k_split1_2xb4_${shot}shot_FT.py"
    echo ">>> Running Task: sardet100k_GFSDet/split1 SHOT_NUM=${shot} ..."
