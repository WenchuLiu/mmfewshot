...
load_from =     'work_dirs/meta-rcnn/sar-aircraft/split1/2xb4_BT/base_model_random_init_bbox_head.pth'
work_dir = 'work_dirs/meta-rcnn/sar-aircraft/split1/2xb4_10shot_FT/'
# model settings
