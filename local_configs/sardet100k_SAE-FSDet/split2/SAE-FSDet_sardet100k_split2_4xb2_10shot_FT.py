...
base_classes = ('aircraft', 'car', 'tank', 'bridge', 'harbor')
novel_classes = ('ship',)
...
load_from = 'work_dirs/SAE-FSDet/sardet100k/split2/4xb2_BT/latest.pth'
work_dir = 'work_dirs/SAE-FSDet/sardet100k/split2/4xb2_10shot_FT/'
