...
python tools/detection/misc/initialize_bbox_head.py --src1 work_dirs/mpsr/sardet100k/split1/2xb2_BT/latest.pth --method random_init --save-dir work_dirs/mpsr/sardet100k/split1/2xb2_BT/ --sardet100k --sardet100k_split 1
