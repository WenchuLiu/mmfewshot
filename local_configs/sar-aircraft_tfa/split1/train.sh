...
python tools/detection/misc/initialize_bbox_head.py --src1 work_dirs/tfa_sar-aircraft_split1_2xb8_BT/latest.pth --method random_init --save-dir work_dirs/tfa_sar-aircraft_split1_2xb8_BT/ --sar_aircraft

# Step 3: Fine-tuning (6 shots)
for shot in 1 2 3 5 10 30
do
    CONFIG="local_configs/sar-aircraft_tfa/split1/tfa_sar-aircraft_split1_2xb8_${shot}shot_FT.py"
