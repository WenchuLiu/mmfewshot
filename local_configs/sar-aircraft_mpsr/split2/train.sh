#!/bin/bash
# sar-aircraft_mpsr split2 training script
...
do
    CONFIG="local_configs/sar-aircraft_mpsr/split2/mpsr_sar-aircraft_split2_2xb4_${shot}shot_FT.py"
    echo ">>> Running Task: sar-aircraft_mpsr/split2 SHOT_NUM=${shot} ..."
