...
def get_copy_dataset_type(dataset_type: str) -> str:
    ...
    elif dataset_type in ['FewShotSARDet50KDataset', 'FewShotSARDet50KDefaultDataset']:
        copy_dataset_type = 'FewShotSARDet50KCopyDataset'
    elif dataset_type in ['FewShotSARDet100KDataset', 'FewShotSARDet100KDefaultDataset']:
        copy_dataset_type = 'FewShotSARDet100KCopyDataset'
    elif dataset_type in ['FewShotSARAircraftDataset', 'FewShotSARAircraftDefaultDataset']:
        copy_dataset_type = 'FewShotSARAircraftCopyDataset'
    else:
